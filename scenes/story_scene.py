...
class StoryScene:
    def __init__(self, screen: pygame.Surface, script_path: str):
        ...
        # 폰트
        self.fnt_speaker = pygame.font.SysFont("Arial", 20, bold=True)
        self.fnt_dialog  = pygame.font.SysFont("Arial", 17)
        self.fnt_choice  = pygame.font.SysFont("Arial", 19, bold=True)
        self.fnt_system  = pygame.font.SysFont("Arial", 16, bold=True)
        self.fnt_sm      = pygame.font.SysFont("Arial", 13)
